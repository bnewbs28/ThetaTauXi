        ...
        <div id="container">
            <div id="content">
                <div id="content" class="entry-content blog">
    				...
    				<h3 class="page-title author"><?php printf(__('Author Archives: <span class="vcard">%s</span>', 'hbd-theme'), "<a class='url fn n' href='$authordata->user_url' title='$authordata->display_name' rel='me'>$authordata->display_name</a>") ?></h3>
